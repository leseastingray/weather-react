...
// more detailed day info when a weatherListItem is selected
class CurrentDay extends Component {
  ...
  render() {
    ...
    // returns current day with image and descriptions of day's weather details
    return (
  ...
  // also need getWeekday here! returns day name of date
  getWeekday(date) {
